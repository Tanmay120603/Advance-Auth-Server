exports.getMailVerificationContent=function (user,otp,redirectUrl){
    ...
    <div style="width: 100%; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border: 1px solid #e0e0e0;">
        ...
        <div style="font-size: 16px; line-height: 1.5;">
            ...
            <a href="${redirectUrl}" style="display: inline-block; padding: 10px 20px; font-size: 16px; font-weight: bold; color: #ffffff; background-color: #4CAF50; text-decoration: none; border-radius: 5px; margin-top: 20px; text-align: center;">Verify Email</a>
